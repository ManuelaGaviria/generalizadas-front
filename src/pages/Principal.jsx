        ...
        <div>
            ...
            <div className='principal-container'>
                <Contenedor animate={true}>
                    <div className='flex'>
                        <MdAccountTree className='icon-pet' />
                        <h1 className='titulo'>Árbol Genealógico</h1>
                        <MdAccountTree className='icon-pet' />
                    </div>
                    <div>
                        <div><ButtonLink destino="/personas" clase="ButtonNav">Gestionar Personas</ButtonLink></div>
